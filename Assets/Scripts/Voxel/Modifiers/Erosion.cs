...
public class Erosion : ProceduralModifier
{
    ...
    public override void Execute() {
        ...
        for(int i = 0; i < voxelContainer.roomLocations.Length; i++) {
            singularityList.Add(new Singularity((int)voxelContainer.roomLocations[i].x, (int)voxelContainer.roomLocations[i].y, (int)voxelContainer.roomLocations[i].z, PlanetProfileLoader.activeProfile.erosionSetting.baseSingularityStrength, 8, 2));
        }
